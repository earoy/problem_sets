...
```{r}
 ...
 ggplot(diamonds, aes(x=carat, y=price)) +  # first you set the aesthetic and dataset
...
```{r}
 ...
 ggplot(diamonds, aes(x=carat, y=price)) +  # first you set the aesthetic and dataset
 geom_point() +  # then you add geoms
 geom_point(aes(colour = cut,shape = clarity))
...
# to save:
# set plot to variable, say p
# ggsave("Location/to/Save/file.pdf", plot = p) 
# or pdf device. Can set height and width
