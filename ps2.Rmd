...
## your code here
echo=TRUE
range(d$Game1Angry1, na.rm = TRUE) #exclude N/A values
```
...
performance_diff_summary_d = performance_diff_d %>%
  ...
  summarise(MeanImprovementScore = mean(ImprovementScore,na.rm = T),
            SEM = (sd(ImprovementScore,na.rm=T)/sqrt(length(performance_diff_d$ImprovementScore[!is.na(performance_diff_d$ImprovementScore)])))) #exclude NA's from sample size
  ## Your code here
```
